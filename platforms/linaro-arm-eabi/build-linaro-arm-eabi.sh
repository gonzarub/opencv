...
#   -> Uncompress into /opt/linaro
#   -> Create setings.sh:
#      if [ -n "${PATH}" ]; then
#        export PATH=/opt/linaro/gcc-linaro-4.9-2015.02-3-x86_64_arm-eabi/bin:$PATH
#      else
#        export PATH=/opt/linaro/gcc-linaro-4.9-2015.02-3-x86_64_arm-eabi/bin:$PATH
#      fi

SDK_ENV=/opt/linaro/gcc-linaro-4.9-2015.02-3-x86_64_arm-eabi/settings.sh 
TOOLCHAIN_CMAKE=../linaro-arm-eabi.toolchain.cmake
